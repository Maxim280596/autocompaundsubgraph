...
import {
  ...
  UpgradeStrat,
  Withdraw
} from "../generated/BlaizeVaultV1/BlaizeVaultV1"
...
export function handleApproval(event: Approval): void {
  ...
  // - contract.busdToken(...)
  // - contract.decimals(...)
  // - contract.getConvertedLptoUSD(...)
  // - contract.getPricePerFullShare(...)
  // - contract.getTotalAPY(...)
  // - contract.getTotalContractRewards(...)
  // - contract.getUserAPY(...)
...
export function handleSetLockPeriod(event: SetLockPeriod): void {}
